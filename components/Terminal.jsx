  ...
  const handleSubmit = (e) => {
    ...
    if (cmd === "resume") {
      ...
      setTimeout(() => {
        ...
        link.href = "/SUJAY_KUMAR_GIRI_CV.pdf";
        link.setAttribute("download", "SUJAY_KUMAR_GIRI_CV.pdf");
...
https://drive.google.com/file/d/1paz5PbPtZV13vX9kXn4Nl8UUVyovJj7i/view?usp=sharing`;
